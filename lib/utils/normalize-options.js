 ...
 * @param {boolean} [options.includeHidden=false] The flag to copy dot files.
 ...
 * @returns {{baseDir:string,clean:boolean,dereference:boolean,includeEmptyDirs:boolean,includeHidden:boolean,initialCopy:boolean,outputDir:string,preserve:boolean,source:string,transform:any[],toDestination:any,update:boolean}} The normalized options.
 * @private
 */
